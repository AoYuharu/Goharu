"""
Timed QQ Bot Echo Test - runs for 30 seconds then exits
"""
...
class SessionSource:
    def __init__(self, platform, chat_id, chat_type, user_id, user_name, message_id=None):
...
class MessageEvent:
    def __init__(self, source, text, message_type, timestamp, raw_data):
        self.source = source
        self.text = text
...
async def main():
    print("=" * 60)
    print("QQ Bot Echo Test (30 seconds)")
    print("=" * 60)
    print()
    ...
    try:
        ...
        if success:
            print()
            print("=" * 60)
            print("Bot is listening for 30 seconds!")
            print("Send a message to test echo functionality")
            print("=" * 60)
            print()
